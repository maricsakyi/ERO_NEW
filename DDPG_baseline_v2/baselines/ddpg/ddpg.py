...
class DDPG(object):
    ...
    def setup_critic_optimizer(self):
        ...
        self.td_errors = self.normalized_critic_tf - normalized_critic_target_tf
    ...
    def train(self, prob_model):
        ...
        ops = [self.actor_grads, self.actor_loss, self.critic_grads, self.critic_loss, self.td_errors]
        ...
        # Update TD errors
        batch_inxes = batch['batch_idxs'].flatten()
        self.memory.update_td_errors(batch_inxes, td_errors.flatten())
        
        # Update probs
        X = self.memory.get_X_by_idxs(batch_inxes)
        new_probs = prob_model.get_P(X).flatten()
        self.memory.update_probs(batch_inxes, new_probs)
