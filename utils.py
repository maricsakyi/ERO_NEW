...
def create_data_path(saving_folder, env_id, trial_id):
    data_path = saving_folder + env_id + '/' + 'meta_rollout' + str(trial_id) + '/'
    if os.path.exists(data_path):
        i = 1
        while os.path.exists(saving_folder + env_id + '/' + 'meta_rollout' + str(trial_id + 100 * i) + '/'):
                #saving_folder + env_id + '/' + str(trial_id + 100 * i) + '/'):
            i += 1
        trial_id += i * 100
